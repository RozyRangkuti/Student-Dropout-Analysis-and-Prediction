...
def main():
    ...
    with tab_single:
        ...
        with st.container():
            ...
            with col_displaced:
                displaced = 1 if st.checkbox(
                    'Displaced', help="Whether the student's is  a displaced person") else 0
            with col_debtor:
                debtor = 1 if st.checkbox(
                    'Debtor', help="Whether the student's is a debtor") else 0
        ...
        data = [[
            marital_status, application_mode, prev_qualification_grade,
    ...
    with tab_multiple:
        with st.expander('**User Guide**'):
            ...
            with open('template_student_data.xlsx', 'rb') as file:
                st.download_button(
        ...
        uploaded_file = st.file_uploader(
            ...
            type=['xlsx', 'xls'],
            help='Upload student data with template format')
        ...
        if uploaded_file is not None:
            ...
            # Separate the ID and Name Columns
